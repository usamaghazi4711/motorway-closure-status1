                ...
                <div className="grid gap-1.5 sm:gap-2 min-w-[320px]">
                  <div className="grid gap-1.5 sm:gap-2 pb-2 border-b-4 border-gray-500 font-semibold text-[10px] sm:text-xs" style={{ gridTemplateColumns: '25px 1fr 55px 55px' }}>
                    ...
                    <div className="text-center">
                      <div>North</div>
                      <div className="text-[8px] sm:text-[9px] font-normal text-gray-600 mt-0.5">({motorwayData.northDir})</div>
                    </div>
                    <div className="text-center">
                      <div>South</div>
                      <div className="text-[8px] sm:text-[9px] font-normal text-gray-600 mt-0.5">({motorwayData.southDir})</div>
                    </div>
                  </div>
